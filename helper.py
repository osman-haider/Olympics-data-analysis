...
def fetch_medal_telly(df, years, country):
...
def most_successful(df, sport):
    # first we drop those rows who has null values in medal column
    ...
    x = x.rename(columns={'count': 'Medal'})
    return x
