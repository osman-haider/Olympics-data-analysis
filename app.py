...
if user_menu == 'Medal Tally':
    ...
    years,country = helper.country_yaer_list(df)
    selected_year = st.sidebar.selectbox("select year",years)
    selected_country = st.sidebar.selectbox("select country",country)

    medal_tally = helper.fetch_medal_telly(df,selected_year,selected_country)
...
if user_menu == 'Overall Analysis':
    ...
    st.title("No. of Events of over the time (Every Sport)")
    ...
    st.title("Most Successful Athlets")
...
if user_menu == 'Country-wise analysis':
    ...
    contry_df = helper.yearwise_medal_telly(df,selected_country)
    fig = px.line(contry_df, x='Year', y='Medal')
    st.title(selected_country +" Country wise medal telly over the year")
    st.plotly_chart(fig)

    st.title(selected_country + " excels in fowling sports")
...
if user_menu == 'Athlete wise analysis':
    ...
    st.title("Men vs Woman partication over the year")
